...
async function handleClick() {
    ...
    if(keyword != '' && location != ''){
            ...
            let response = await fetch(`http://127.0.0.1:8080/allEvents?keyword=${keyword}&radius=${distance}&category=${category}&location=${location}`, {
                method: 'GET',
                xhrFields: {
                    withCredentials: true
                },
...
async function displayDetail(Event_id){
    ...
    let response = await fetch(`http://127.0.0.1:8080/eventDetails?event_id=${Event_id}`, {
                method: 'GET',
                xhrFields: {
                    withCredentials: true
                },
...
async function displayVenue(venue){
    ...
    let response = await fetch(`http://127.0.0.1:8080/venueDetails?keyword=${venue}`, {
                method: 'GET',
                xhrFields: {
                    withCredentials: true
                },
